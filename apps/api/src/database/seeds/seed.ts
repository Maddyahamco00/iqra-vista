...
import { fetchSurahList, fetchAllVerses, TanzilVerse } from './fetch-tanzil';
...
async function main() {
  ...
  try {
    ...
    const allVerses: TanzilVerse[] = await fetchAllVerses();
    ...
    console.warn('⚠️ Quran API unavailable; skipping surah and verse seeding.');
    console.warn(error);
  }
